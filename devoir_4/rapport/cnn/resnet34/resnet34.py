...
# multiply the learning rate by gamma after 10 epochs, 25 epochs, 30 epochs (was 10,25,30,40)
scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[7,15,25,35,45], gamma=0.1)
...
torch.save(model.state_dict(), 'resnet34_valid.ckpt')
